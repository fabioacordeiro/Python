...
class MyOpen:
    ...
    def __exit__(self, class_exception, exception_, traceback):
        ...
        #raise class_expetion('Minha mensagem de erro')
        #Colocando minhas próprias mensagens de erros
        #raise class_exception(*exception_.args).with_traceback(traceback)
        exception_.add_note('Minha nota')

        #return True # Se colocar o return True o sistema ignora o erro porque você está dizendo que tratou o erro
...
with MyOpen('Aula149.txt', 'w') as arquivo:
    ...
    arquivo.write('\n')
    arquivo.write('\n')
    arquivo.write('b = MyContextManager1("Aula149.txt", "w")\n', 123) #Erro causado proposital para ver a mensagem de erro
