...
'''
while t1.is_alive():
    print('Esperando fim t1')
    sleep(1)
'''
'''
executar o join para interromper a thread, ou seja, o programa irá
aguardar a finalização da thread para poder iniciar o novo código
