...
import PySimpleGUI as sg #Biblioteca do Tema
from random import choice #Biblioteca randomica
...
class TelaPython:
    ...
    #Para randomizar os temas, você pode fixar retirando esta funcionalidade e escolhendo um de sua preferencia
    Tema = choice(Temas)
